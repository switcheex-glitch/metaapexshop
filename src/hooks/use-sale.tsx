...
// Скидка 30% с 7 марта 23:00 МСК до 8 марта 23:59 МСК
const SALE_START = new Date('2026-03-07T23:00:00+03:00').getTime();
const SALE_END = new Date('2026-03-08T23:59:59+03:00').getTime();
